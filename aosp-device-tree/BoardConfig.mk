...
BOARD_KERNEL_CMDLINE := video=vfb:640x400,bpp=32,memsize=3072000 disable_dma32=on swinfo.fingerprint=ishtar:13/V816.0.23.11.8.DEV:user mtdoops.fingerprint=ishtar:13/V816.0.23.11.8.DEV:user bootconfig
